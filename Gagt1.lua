...
stroke.Thickness = 1
stroke.Color = Color3.fromRGB(150, 180, 200) -- Xanh lam nhẹ
...
title.TextColor3 = Color3.fromRGB(50, 70, 100) -- Xanh đậm nhẹ
title.TextSize = 22
...
closeButton.BackgroundColor3 = Color3.fromRGB(255, 100, 100) -- Đỏ pastel
...
local function createButton(name, positionY, text, callback)
    ...
    button.BackgroundColor3 = Color3.fromRGB(100, 150, 200) -- Xanh lam pastel
...
toggleButton.Text = "" -- Không có text
...
-- Kéo thả cho Frame (menu) - Hỗ trợ cả chuột và touch
...
-- Kéo thả cho nút bật/tắt - Hỗ trợ cả chuột và touch
...
local function updateToggle(input)
    ...
    print("Toggle moved to: X=" .. newX .. ", Y=" .. newY) -- Debug vị trí
end
toggleButton.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
